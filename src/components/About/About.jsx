                ...
                <Container>
                    ...
                    <div className="about__main">
                        ...
                        <div className="about__right">
                            ...
                            <p>In my projects, I usually try to use modern technologies that can change according to the needs. These technologies include React, Redux, Next.js, Tailwindcss and much more.</p>
                            ...
                            <p>During the rest of these experiences, I continued to develop projects on freelance platforms, focusing on new technological developments.</p>
